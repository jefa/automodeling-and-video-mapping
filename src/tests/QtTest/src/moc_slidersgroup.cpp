...
**
** Created: Sun Mar 20 19:49:48 2011
...
int SlidersGroup::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: setMinimum((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 3: setMaximum((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 4: invertAppearance((*reinterpret_cast< bool(*)>(_a[1]))); break;
        case 5: invertKeyBindings((*reinterpret_cast< bool(*)>(_a[1]))); break;
        default: ;
        }
        _id -= 6;
    }
