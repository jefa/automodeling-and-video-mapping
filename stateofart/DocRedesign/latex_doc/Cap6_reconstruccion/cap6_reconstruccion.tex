...
\cite{LibroCompGrafica3} La geometía epipolar entre dos vistas es la geometía dada por la intersección de los planos imagen de cada cámara con el plano epipolar, este plano es el definido por el punto a representar $X$ y los dos centros de cámaras $C$ y $C'$.
...
La linea epipolar $l'$ en la segunda imagen es la proyección en la segunda imagen del rayo que parte del punto $x$ y llega al centro $C$ de la primer cámara. Hay un mapeo de un punto en una imagen con la línea epopolar en la otra imagen.
\[  x \to l'
\]
 
El mapeo en proyectiva de puntos a lineas es representado por $F$ la matriz fundamental.
...
Existen variedad de algorimos que solucionan el problema de correspondecia y cálculo de desigualdad entre los puntos de las dos imágenes se clasifican según diferencias en las imágenes y
