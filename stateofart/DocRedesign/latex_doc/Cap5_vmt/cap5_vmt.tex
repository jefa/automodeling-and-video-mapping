...
En \emph{VMT}, los nodos se definen agregando proyectores a la escena, asignando propiedades de ubicación para cada uno en particular para luego definir la red de nodos esclavo con la información de conectividad necesaria y su correspondiente asociación al proyector que tiene conectado el nodo.
