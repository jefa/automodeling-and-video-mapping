...
\begin{figure}[H]
  ...
  \caption[Reinhard Klette, Karsten Schlüns, Andreas Koschan, Computer Vision:Three-Dimensional Data from Images, Fig. 9.1]{Propiedades trigonométricas para escena bidimensional.}
...
\begin{figure}[H]
  ...
  \caption[Reinhard Klette, Karsten Schlüns, Andreas Koschan, Computer Vision:Three-Dimensional Data from Images, Fig. 9.2]{Propiedades trigonométricas para escena tridimensional.}
  \label{fig:Triangulacion2}
\end{figure}

Se asume $Z = f$ siendo $f$ el plano en el cual se proyecta el punto $P(X_0, Y_0, Z_0)$, obteniendo como resultado de la proyección el punto $p(x,y)$.
