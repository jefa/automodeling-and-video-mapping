...
\begin{itemize}
  ...
  \end{itemize}
Para técnicas de modelado utlizando polígonos y curvas, algunas de las herramientas más populares son Maya y 3D Studio Max, mientras que para la realización de esculpido digital son también muy utilizadas 3D-Coat, Zbrush, y Mudbox. 
% imagenes con referencia de cada una de las herramientas
