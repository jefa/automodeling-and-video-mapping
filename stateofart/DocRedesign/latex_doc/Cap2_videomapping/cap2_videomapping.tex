...
\begin{figure}[H]
  ...
  \caption{Típico flujo para el procesamiento de nubes de puntos.}%  Fuente: \emph{CGAL} http://www.cgal.org%
  \label{fig:Mesh-CGAL}
\end{figure}

A continuacion se detallan los algoritmos asociados a cada uno de los pasos enumerados que se correspodnen con lo implementado en \emph{VcgLib} 
