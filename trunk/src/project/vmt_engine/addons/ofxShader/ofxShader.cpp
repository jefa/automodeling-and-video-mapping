...
void ofxShader::setUniformVariable4f (char * name, float value, float value2, float value3, float value4){
	if (bLoaded == true){
		glUniform4fARB(glGetUniformLocationARB(shader, name), value, value2, value3, value4);
	}
}
