...
Esta técnica tiene una gran variedad de aplicaciones que van desde fines artísticos hasta publicitarios. En los últimos tiempos es común observar proyecciones sobre fachadas para celebrar el aniversario de una fecha patria, o de una construcción emblemática, también distintas escuelas de arte realizan festivales de interez turístico realizados periodicamente en ciertas cuidades. Ejemplo de esto último es el Festival de Lyon\cite{FestivalLyon}, llevado a cabo en dicha cuidad, donde los asistentes pueden circular libremente durante el transcurso de los espectáculos. Otro tipo de modalidad se da en espectáculos de menor tamaño, generalmente realiados en espacios cerrados, constan de proyecciones sobre objetos tridimensionales que pueden ser generados específicamene para este propósito como maquetas, u otros ya existenes como ser autómoviles, teléfonos moviles, calzados, etc. La proyección de imágenes es vista también en nuevas tendencias en el ambiente artistíco donde se incorpora el \emph{video mapping} en obras teatrales, logrando una ilusón de interacción de los actores con las imágnes proyectadas, pasando éstas a formar parte parte de la obra.
