...
Los patrones discretos asignan el mismo valor a todos los puntos de la region representada por la misma codificacion, mientras que los continuos utilizan una representan mas suavizada en donde cada \emph{pixel} tienen una codificacion unica dentro de la region, variandose la intensidad o el color a lo largo de uno o ambos ejes en la proyeccion.
