...
\begin{figure}[H]
  ...
  \caption[http://usa.autodesk.com]{Mudbox}
  \label{fig:Mudbox}
\end{figure}
...
Un algoritmo que utiliza codificación binaria es el llamado \emph{Three Phase-Shifting} utiliza tres ondas sinusoidales para la proyección del patrón es presentado por Zhang\cite{ZhangS} e implementado por Kyle McDonalds en \cite{KyleMcDonald}. Este algoritmo es aplicable únicamente para superficies con curvas continuas. Superficies disjuntas o con aristas pronunciadas serán capturadas de forma distorsionada.
\begin{figure}[H]
  \centering
    \includegraphics[width=0.8\textwidth]{./Cap2_videomapping/diagramaLS.png}
  \caption{Instalación básica de proyección de patrones y sistema de \emph{Phase-Shifting} }
  \label{fig:phase21}
\end{figure}
\begin{figure}[H]
  \centering
...
Existen varias implementaciones de esta técnica de calibración basado en el modelo inverso de la cámara. Una de estas implementaciones es BYO3D\footnote{http://mccammon.ucsd.edu/~bgrant/bio3d/}, que se encuentra disponible para MATLAB\footnote{http://www.mathworks.com/products/matlab/} y como una extensión a la biblioteca de visión computacional \emph{OpenCV}\footnote{http://opencv.org/}.
