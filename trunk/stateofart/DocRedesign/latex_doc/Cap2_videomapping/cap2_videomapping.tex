...
Un algoritmo que utiliza codificación binaria es el llamado \emph{Three Phase-Shifting} utiliza tres ondas sinusoidales para la proyección del patrón es presentado por Zhang\cite{ZhangS} e implementado por Kyle McDonalds en \cite{KyleMcDonald} . Éste algoritmo es aplicable únicamente para superficies con curvas continuas. Superficies disjuntas o con aristas pronunciadas serán capturadas de forma distorsionada.
\begin{figure}[H]
  \centering
