...
%REESCRIBIR esta oración con las siguientes 4 para que quede bien.
...
%Realizar imagen de una textura simple y un quad deformado para explicar como se mapean las texturas.
%\begin{figure}[H]
%  \centering
%    \includegraphics[width=0.7\textwidth]{./Cap2_videomapping/3dillusion}
%  \caption[vvvv.org]{Izq. Ilusión 3D lograda. Der. No se logra la ilusión.}
...
\subsubsection{Calibración de la proyección}
