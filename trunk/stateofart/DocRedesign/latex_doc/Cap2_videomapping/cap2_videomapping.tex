...
\begin{figure}[H]
  ...
  \caption{Esquema de proyección.}%no aplica referencia imagen creada por nosotros%
...
\begin{figure}[H]
  \centering
    \includegraphics[width=0.7\textwidth]{./Cap2_videomapping/EjemploMallaTriangular.png}
