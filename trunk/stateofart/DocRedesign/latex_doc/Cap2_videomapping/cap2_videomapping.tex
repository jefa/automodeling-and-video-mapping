...
Esta división surge del estudio del estado del arte que se apoya en entrevistas a \emph{VJs} y un relevamiento de las aplicaciones por ellos sugeridas, anexadas en los apéndices \titleref{chapter:aportes} y \titleref{chapter:aplicaciones}.
...
Este modelo será la base para trabajar en posteriores etapas y sobre el cuál se diseñará el espectáculo. En la figura \ref{fig:Efecto1} y \ref{fig:Efecto2} se presenta un efecto en una herramienta de software realizado con la imagen de la fachada como base realizando distorsiones sobre la misma.

\begin{minipage}{0.50\textwidth}
\begin{flushleft} \large
\begin{figure}[H]
  \centering
    \includegraphics[width=0.7\textwidth]{./Cap2_videpmapping/celestin_head.jpg}
...
\begin{figure}[H]
  \centering
    \includegraphics[width=0.75\textwidth]{./Cap2_videpmapping/realcelestins_headshot.jpg}
...
% 
% distinto nivel de abstracción, bidimensional es más fácil de implementar y es intuitivo para superficies planas. No tanto para distintas de las planas.
% tridimensional incluye elementos como cámaras y proyectores virtuales, es más intuitivo para superficies no planas (incluye el caso de las planas)
% 
