...
Una cámara hace corresponder puntos tridimensionales en el espacio con puntos bidimensionales en su plano imagen. En particular se estudiará el modelo de camaras mas simple que es el modelo pinhole.


Se considera que el centro de proyección $C$, el centro óptico de la cámara, coincide con el origen del sistema de coordenadas y que $Z = f$ (plano imagen o plano focal).

Sea $C$ el centro de poryeccion, el que coincide con el centro de la camara, y por tanto el centro de la camara, como el origen de un sistema de coordenadas Euclideano, y $Z = f$ el plano de la imagen o plano focal.
