...
El modelo ideal que se utiliza en las cámaras es el modelo \emph{pinhole}. Este se presenta para un caso básico. Se considera que el centro de proyección $C$, el centro óptico de la cámara, coincide con el origen del sistema de coordenadas y que $Z = f$ (plano imagen o plano focal).
...
Dado $A = (A_X,A_Y,A_Z,1)^T$ y la proyección $a$ sobre el plano imagen, la correspondencia utilizando el método pinhole es:
$a=PA$
